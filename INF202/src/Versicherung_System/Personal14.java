...
public class Personal {
					...
					
			{
				...
				this.setMaklergebühr(maklergebühr);
			}

			private void setTelefonnummer(String telefonnummer2) {
				// TODO Auto-generated method stub
				
			}

			private void setArbeitsanfangsdatum(String arbeitsanfangsdatum2) {
				// TODO Auto-generated method stub
			...
			public void setMaklergebühr(String maklergebühr) {
				this.maklergebühr = maklergebühr;
			}
			public String getmaklergebühr() {
				return maklergebühr;
			}
		}
